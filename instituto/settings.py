...
SECRET_KEY = 'django-insecure-#b=0q=w)#20_!l%6y%mv=2gy-4cc)xv%vsomb+3$rh=e7u9bzo'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'alumnos/static'),  # Adjust 'static' to your actual static files directory
]
